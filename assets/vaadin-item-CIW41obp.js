import{r as u,i as m,M as k,E as w,h,F as I,f as p,P as d,N as L,D as E,O as A,C as O,n as P,m as V}from"./index-Br2wLBKl.js";import{a as q,r as F}from"./dom-utils-DPL7MVhW.js";u("vaadin-form-layout",m`
    :host {
 ...
 * license.
 */class y extends k(w(p(d))){static get template(){return h`
      <style>
        :host {
          display: block;
          max-width: 100%;
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class g extends L(p(E(d))){static get template(){return h`
      <style>
        :host {
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class x extends w(T(p(O(d)))){static get template(){return h`
      <style>
        :host {
          display: flex;
        }
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class N extends p(d){static get template(){return h`
      <style>
        :host {
          display: inline-flex;
          flex-direction: row;
