import{s as m,a8 as o,x as a,a9 as u}from"./index-DpEFpdLU.js";function d(r){return r.resultMessage?r.resultMessage:r.sourceConstraintComponent?`Violated ${u(r.sourceConstraintComponent.id.value)}`:"Unspecified error"}const n=r=>a` <li>${d(r)}</li> `;function f({focusNodes:r,...s},e){return a`
    <ul>
      ${s.errors.map(n)}
