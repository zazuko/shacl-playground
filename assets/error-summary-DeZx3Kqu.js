import{o as m,ab as o,ac as u,x as a}from"./index-BfYWPPsp.js";function d(r){return r.resultMessage?r.resultMessage:r.sourceConstraintComponent?`Violated ${u(r.sourceConstraintComponent.id.value)}`:"Unspecified error"}const n=r=>a` <li>${d(r)}</li> `;function f({focusNodes:r,...s},e){return a`
    <ul>
      ${s.errors.map(n)}
