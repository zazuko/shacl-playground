import{s as m,ag as o,x as a,ah as u}from"./index-Br2wLBKl.js";function d(r){return r.resultMessage?r.resultMessage:r.sourceConstraintComponent?`Violated ${u(r.sourceConstraintComponent.id.value)}`:"Unspecified error"}const n=r=>a` <li>${d(r)}</li> `;function f({focusNodes:r,...s},e){return a`
    <ul>
      ${s.errors.map(n)}
