import{r as h,i as n,f as v,D as ie,P as b,h as y,g as re,j as p,k as se,l as oe,S as f,C as z,K as B,m as ae,n as F,E as q,s as x,p as ne,x as u,a as le,o as R,t as V,q as j,u as c,v as de}from"./index-3w6te0oK.js";import{m as he}from"./rdf-editor-y5PgPFo7.js";import{I as ue,L as ce}from"./vaadin-item-HSLyiYGW.js";import{o as pe,O as me,p as _e}from"./templates-5Uz6ght8.js";import{g as fe,r as ge,a as N}from"./dom-utils-VPENXKn6.js";h("vaadin-input-container",n`
    :host {
 ...
 */class S extends v(ie(b)){static get is(){return"vaadin-input-container"}static get template(){return y`
      <style>
        :host {
          display: flex;
          align-items: center;
    ...
    `}static get properties(){return{disabled:{type:Boolean,reflectToAttribute:!0},readonly:{type:Boolean,reflectToAttribute:!0},invalid:{type:Boolean,reflectToAttribute:!0}}}ready(){super.ready(),this.addEventListener("pointerdown",t=>{t.target===this&&t.preventDefault()}),this.addEventListener("click",t=>{t.target===this&&this.shadowRoot.querySelector("slot:not([name])").assignedNodes({flatten:!0}).forEach(e=>e.focus&&e.focus())})}}customElements.define(S.is,S);/**
 * @license
...
`;h("",U,{moduleId:"lumo-field-button"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ve=n`
...
`;h("",W,{moduleId:"lumo-required-field"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const be=n`
...
`,k=[W,U,ve,be];h("",k,{moduleId:"lumo-input-field-shared-styles"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Q=n`
...
`;h("",Q,{moduleId:"lumo-menu-overlay-core"});const ye=n`
...
`,K=[pe,Q,ye];h("",K,{moduleId:"lumo-menu-overlay"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const xe=n`
...
`;h("vaadin-select",[k,xe],{moduleId:"lumo-select"});h("vaadin-select-value-button",n`
    :host {
      font-family: var(--lumo-font-family);
      font-size: var(--lumo-font-size-m);
      padding: 0 0.25em;
  ...
  `,{moduleId:"lumo-select-value-button"});const Ce=n`
  :host {
...
`;h("vaadin-select-overlay",[K,Ce],{moduleId:"lumo-select-overlay"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class P extends ue{static get is(){return"vaadin-select-item"}}customElements.define(P.is,P);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class T extends ce{static get is(){return"vaadin-select-list-box"}}customElements.define(T.is,T);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const E={start:"top",end:"bottom"},w={start:"left",end:"right"},O=new ResizeObserver(s=>{setTimeout(()=>{s.forEach(t=>{t.target.__overlay&&t.target.__overlay._updatePosition()})})}),Ee=s=>class extends s{static get properties(){return{positionTarget:{type:Object,value:null},horizontalAlign:{type:String,value:"start"},verticalAlign:{type:String,value:"top"},noHorizontalOverlap:{type:Boolean,value:!1},noVerticalOverlap:{type:Boolean,value:!1},requiredVerticalSpace:{type:Number,value:0}}}static get observers(){return["__positionSettingsChanged(horizontalAlign, verticalAlign, noHorizontalOverlap, noVerticalOverlap, requiredVerticalSpace)","__overlayOpenedChanged(opened, positionTarget)"]}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}__addUpdatePositionEventListeners(){window.addEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes=fe(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach(e=>{e.addEventListener("scroll",this.__onScroll,!0)})}__removeUpdatePositionEventListeners(){window.removeEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach(e=>{e.removeEventListener("scroll",this.__onScroll,!0)}),this.__positionTargetAncestorRootNodes=null)}__overlayOpenedChanged(e,i){if(this.__removeUpdatePositionEventListeners(),i&&(i.__overlay=null,O.unobserve(i),e&&(this.__addUpdatePositionEventListeners(),i.__overlay=this,O.observe(i))),e){const r=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach(o=>{this.__margins[o]=parseInt(r[o],10)})),this.setAttribute("dir",r.direction),this._updatePosition(),requestAnimationFrame(()=>this._updatePosition())}}get __isRTL(){return this.getAttribute("dir")==="rtl"}__positionSettingsChanged(){this._updatePosition()}__onScroll(e){this.contains(e.target)||this._updatePosition()}_updatePosition(){if(!this.positionTarget||!this.opened)return;const e=this.positionTarget.getBoundingClientRect(),i=this.__shouldAlignStartVertically(e);this.style.justifyContent=i?"flex-start":"flex-end";const r=this.__shouldAlignStartHorizontally(e,this.__isRTL),o=!this.__isRTL&&r||this.__isRTL&&!r;this.style.alignItems=o?"flex-start":"flex-end";const a=this.getBoundingClientRect(),l=this.__calculatePositionInOneDimension(e,a,this.noVerticalOverlap,E,this,i),d=this.__calculatePositionInOneDimension(e,a,this.noHorizontalOverlap,w,this,r);Object.assign(this.style,l,d),this.toggleAttribute("bottom-aligned",!i),this.toggleAttribute("top-aligned",i),this.toggleAttribute("end-aligned",!o),this.toggleAttribute("start-aligned",o)}__shouldAlignStartHorizontally(e,i){const r=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const o=Math.min(window.innerWidth,document.documentElement.clientWidth),a=!i&&this.horizontalAlign==="start"||i&&this.horizontalAlign==="end";return this.__shouldAlignStart(e,r,o,this.__margins,a,this.noHorizontalOverlap,w)}__shouldAlignStartVertically(e){const i=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const r=Math.min(window.innerHeight,document.documentElement.clientHeight),o=this.verticalAlign==="top";return this.__shouldAlignStart(e,i,r,this.__margins,o,this.noVerticalOverlap,E)}__shouldAlignStart(e,i,r,o,a,l,d){const g=r-e[l?d.end:d.start]-o[d.end],m=e[l?d.start:d.end]-o[d.start],_=a?g:m,C=_>(a?m:g)||_>i;return a===C}__adjustBottomProperty(e,i,r){let o;if(e===i.end){if(i.end===E.end){const a=Math.min(window.innerHeight,document.documentElement.clientHeight);if(r>a&&this.__oldViewportHeight){const l=this.__oldViewportHeight-a;o=r-l}this.__oldViewportHeight=a}if(i.end===w.end){const a=Math.min(window.innerWidth,document.documentElement.clientWidth);if(r>a&&this.__oldViewportWidth){const l=this.__oldViewportWidth-a;o=r-l}this.__oldViewportWidth=a}}return o}__calculatePositionInOneDimension(e,i,r,o,a,l){const d=l?o.start:o.end,g=l?o.end:o.start,m=parseFloat(a.style[d]||getComputedStyle(a)[d]),_=this.__adjustBottomProperty(d,o,m),L=i[l?o.start:o.end]-e[r===l?o.end:o.start],C=_?`${_}px`:`${m+L*(l?-1:1)}px`;return{[d]:C,[g]:""}}};/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-select-overlay",n`
    :host {
      align-items: flex-start;
      justify-content: flex-start;
    }
  `,{moduleId:"vaadin-select-overlay-styles"});class H extends Ee(me){static get is(){return"vaadin-select-overlay"}requestContentUpdate(){if(super.requestContentUpdate(),this.owner){const t=this._getMenuElement();this.owner._assignMenuElement(t)}}_getMenuElement(){return Array.from(this.children).find(t=>t.localName!=="style")}}customElements.define(H.is,H);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class M extends re(v(b)){static get is(){return"vaadin-select-value-button"}static get template(){return y`
      <style>
        :host {
 ...
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-select",[J,ee],{moduleId:"vaadin-select-styles"});class D extends G(Y(B(Z(q(v(b)))))){static get is(){return"vaadin-select"}static get template(){return y`
      <style>
        ::slotted([slot='value']) {
          flex-grow: 1;
        }
 ...
 */console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-select" is deprecated. Use "@vaadin/select" instead.');class Pe extends x{static get styles(){return n`
    ...
    `}static get properties(){return{selected:{type:Array}}}constructor(){super(),this.selected=[]}render(){const t=Object.keys(ne).sort(this.__selectedFirst.bind(this));return u`<vaadin-form-item label-position="top">
 ...
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */h("vaadin-text-field",Re,{moduleId:"vaadin-text-field-styles"});class $ extends Fe(ze(v(q(b)))){static get is(){return"vaadin-text-field"}static get template(){return y`
      <style>
        [part='input-field'] {
          flex-grow: 0;
        }
      ...
      <slot name="tooltip"></slot>
    `}static get properties(){return{maxlength:{type:Number},minlength:{type:Number}}}static get delegateAttrs(){return[...super.delegateAttrs,"maxlength","minlength"]}static get constraints(){return[...super.constraints,"maxlength","minlength"]}constructor(){super(),this._setType("text")}get clearElement(){return this.$.clearButton}ready(){super.ready(),this.addController(new Te(this,t=>{this._setInputElement(t),this._setFocusElement(t),this.stateTarget=t,this.ariaTarget=t})),this.addController(new Be(this.inputElement,this._labelController)),this._tooltipController=new F(this),this._tooltipController.setPosition("top"),this.addController(this._tooltipController)}}customElements.define($.is,$);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */console.warn('WARNING: Since Vaadin 23.2, "@vaadin/vaadin-text-field" is deprecated. Use "@vaadin/text-field" instead.');class Ve extends x{static get properties(){return{prefixes:{type:Object}}}static get styles(){return n`
      vaadin-form-item {
        max-width: 100%;
      }
    ...
    `}__renderList(t){de(u`
        <vaadin-list-box>
          ${Object.values(he).map(e=>u`
              <vaadin-item value="${e}">${e}</vaadin-item>
            `)}
        </vaadin-list-box>
      `,t)}mapState(t){return{format:t[this.model].format,prefixes:t[this.model].prefixes,customPrefixes:t[this.model].customPrefixes||{}}}mapEvents(){return{"prefix-selected":t=>c.dispatch[this.model].addPrefix(t.detail.value),"prefix-unselected":t=>c.dispatch[this.model].removePrefix(t.detail.value),"custom-prefix-set":t=>c.dispatch[this.model].setCustomPrefix(t.detail)}}__formatSelected(t){c.dispatch[this.model].changeFormat(t.detail.value)}}customElements.define("editor-drawer",je);let A=null;const Ne=10;function Ue(){return A||(A=new Promise(s=>{const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.32.0/addon/display/autorefresh.min.js",t.onload=s,document.head.appendChild(t)})),A}class We extends j(c,x){static get styles(){return n`
      :host {
        display: flex;
        flex-direction: column;
        overflow: scroll;
    ...
    `}static get properties(){return{format:{type:String},graph:{type:String},model:{type:String},prefixes:{type:Array},customPrefixes:{type:Object}}}async firstUpdated(){const t=this.shadowRoot.querySelector("rdf-editor");await t.ready,await Ue(),t.codeMirror.editor.setOption("autoRefresh",!0)}render(){return u`
