import{a9 as c,Z as m,R as C,h as N,v as h,p as d,Y as p,l as L,I,g as E,L as O,c as A,x as P,U as q}from"./index-B-SwLdNe.js";import{a as V,r as F}from"./dom-utils-BhgefGZl.js";c("vaadin-form-layout",m`
    :host {
      --vaadin-form-layout-column-spacing: var(--lumo-space-l);
    }
  `,{moduleId:"lumo-form-layout"});class y extends C(N(h(d))){static get template(){return p`
      <style>
        :host {
          display: block;
          max-width: 100%;
...
`;c("vaadin-item",M,{moduleId:"lumo-item"});class g extends I(h(E(d))){static get template(){return p`
      <style>
        :host {
